...
return [
    ...
    */
    ...
    'disks' => [
        ...
        's3_documents' => [
            ...
            'bucket' => env('AWS_DOCUMENTS_BUCKET', 'documents'),
            'url' => env('AWS_DOCUMENTS_URL', env('AWS_URL')),
            'endpoint' => env('AWS_DOCUMENTS_ENDPOINT', env('AWS_ENDPOINT')),
            'use_path_style_endpoint' => env('AWS_DOCUMENTS_USE_PATH_STYLE_ENDPOINT', false),
            'throw' => false,
            'root' => 'documents', // Папка в бакете
        ],
    ...
    */
    ...
    'links' => [
        ...
        // Для доступа к документам через веб (если нужно)
