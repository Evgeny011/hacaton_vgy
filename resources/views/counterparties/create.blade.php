...
<body>
    <div class="admin-container">
        ...
        <div class="admin-header enhanced">
            ...
            <div class="header-content">
                ...
                <div class="header-text">
                    <h1 class="gradient-text">Создание контрагента</h1>
                    <p class="header-subtitle">Добавление нового контрагента в систему</p>
                </div>
            </div>
        ...
        <div class="form-container enhanced">
            <form action="{{ route('admin.counterparties.store') }}" method="POST" class="user-form enhanced">
                @csrf
                            ...
                            <div class="form-group enhanced">
                                ...
                                <div class="input-wrapper">
                                    <select id="type" name="type" class="form-input enhanced">
                                        ...
                                        <option value="individual" {{ old('type') == 'individual' ? 'selected' : '' }}>Физическое лицо</option>
                                    </select>
                                    <div class="input-icon">
